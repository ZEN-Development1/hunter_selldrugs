...
next_ped = function(drugToSell)
	...
	cops = 0
	ESX.TriggerServerCallback('hunter_selldrugs:getPoliceCount', function(_cops)
		cops = _cops
	end)
			...
			if distance < 2.0 then
				...
				if IsControlJustPressed(0, 38) and canSell then
					...
					if reject <= 3 then
						...
						TriggerServerEvent('hunter_selldrugs:notifycops', drugToSell)
						SetPedAsNoLongerNeeded(npc.ped)
					...
					SetPedAsNoLongerNeeded(npc.ped)
					TriggerServerEvent('hunter_selldrugs:pay', drugToSell)
...
RegisterNetEvent('hunter_selldrugs:findClient')
AddEventHandler('hunter_selldrugs:findClient', next_ped)

RegisterNetEvent('hunter_selldrugs:notifyPolice')
AddEventHandler('hunter_selldrugs:notifyPolice', function(coords)	
